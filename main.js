$(document).ready(function(){
	...
	*/
	$("body").delegate(".category","click",function(event){
		$("#get_product").html("<h3>Aguarde..</h3>");
	...
	/*	quando a página é carregada com sucesso, então há uma lista de marcas quando o usuário clica na marca, recebemos o ID da marca e
de acordo com o id da marca, mostraremos produtos
	*/
	...
	/*
		Na parte superior da página há uma caixa de pesquisa com o botão de pesquisa quando o usuário coloca o nome do produto, então vamos levar o usuário
determinada string e com a ajuda da consulta sql, combinaremos a string fornecida pelo usuário com a coluna de palavras-chave do banco de dados e depois com o produto correspondente
nós vamos mostrar 
	*/
...
se você obter login_success string da página login.php significa que o usuário está logado com sucesso e window.location é
